...
\newenvironment{certificate1}
  ...
  \thispagestyle{empty}
	...
	This is to certify that the report titled \textbf{\title} is a bonafide record of the project done by  \textbf{\studentC} (\studentCroll) of the sixth semester \textbf{\degree} students under the guidance and supervision of \textbf{\projcordinatorA} and \textbf{\projcordinatorB} in partial fulfillment of the requirements for the award of the degree, \degree, at \college, affiliated with Kerala University.
